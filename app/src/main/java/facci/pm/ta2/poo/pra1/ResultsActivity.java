...
public class ResultsActivity extends AppCompatActivity implements  ListView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        // INICIO - CODE5
        //Pregunta 2.2
        // instanciaremos la clase intent para poder llamar la activity detal activity
        //con esto lograremos un intercambio de parámetros
        DataObject object = (DataObject) m_adapter.m_array.get(position);
        String str1 = object.m_objectId;
